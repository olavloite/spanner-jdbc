...
Sign up for a free trial account for a Google Cloud Spanner Emulator on https://emulator.googlecloudspanner.com . A tutorial on how to set it up can be found on http://www.googlecloudspanner.com/2018/06/google-cloud-spanner-emulator.html
...
Releases are available on Maven Central and here: https://github.com/olavloite/spanner-jdbc/releases. Current release is version 1.0.10.
...
&lt;<span class="pl-ent">dependency</span>&gt;
 	&lt;<span class="pl-ent">groupId</span>&gt;nl.topicus&lt;/<span class="pl-ent">groupId</span>&gt;
    	...
    	&lt;<span class="pl-ent">version</span>&gt;1.0.10&lt;/<span class="pl-ent">version</span>&gt;
&lt;/<span class="pl-ent">dependency</span>&gt;
</pre></div>
