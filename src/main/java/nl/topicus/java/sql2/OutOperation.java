...
public interface OutOperation<T> extends ParameterizedOperation<T> {
   ...
   */
  public OutOperation<T> resultProcessor(Function<Result.OutParameterMap, ? extends T> processor);
  ...
  @Override
  public OutOperation<T> set(String id, CompletableFuture<?> valueFuture);

  @Override
  public OutOperation<T> set(String id, CompletableFuture<?> valueFuture, SqlType type);

  @Override
  public OutOperation<T> set(String id, CompletionStage value, SqlType type);

  @Override
  public OutOperation<T> set(String id, CompletionStage value);

  @Override
  public OutOperation<T> timeout(long milliseconds);
