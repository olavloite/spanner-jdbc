...
public interface CountOperation<T> extends Operation<T> {
   ...
   * 
   * ISSUE: Is this needed? This type could just extend Operation&lt;Long&gt;.
   *
   * @param processor processes the count produced by executing this
   ...
   */
  public CountOperation<T> resultProcessor(Function<Result.Count, T> processor);
