...
public interface ParameterizedCountOperation<T> extends ParameterizedOperation<T>, CountOperation<T> {
  ...
  @Override
  ParameterizedCountOperation<T> resultProcessor(Function<Result.Count, T> processor);
  ...
  @Override
  public default ParameterizedCountOperation<T> set(String id, CompletionStage value) {
    return set(id, value.toCompletableFuture());
  }

  @Override
  public default ParameterizedCountOperation<T> set(String id, CompletionStage value, SqlType type) {
