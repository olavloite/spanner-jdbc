...
public interface ParameterizedRowOperation<T> extends ParameterizedOperation<T>, RowOperation<T> {
  ...
  @Override
  public ParameterizedRowOperation<T> rowAggregator(BiFunction<? super T, Result.Row, ? extends T> aggregator);
  ...
  @Override
  public default ParameterizedRowOperation<T> set(String id, CompletionStage value, SqlType type) {
    return set(id, value.toCompletableFuture(), type);
  }

  @Override
  public default ParameterizedRowOperation<T> set(String id, CompletionStage value) {
