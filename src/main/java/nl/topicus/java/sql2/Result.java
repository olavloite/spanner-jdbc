...
public interface Result {
  ...
  public static interface ResultMap extends Result {
     ...
     * parameter markers in the SQL. Alternatively he implementation may assign
   ...
   */
  public static interface Row extends ResultMap, Flow.Subscription {
     ...
     * 
     * ISSUE: Should this return {@link java.util.concurrent.CompletableFuture}?
     *
     * @return a {@link java.util.concurrent.Future} that will be true iff this the last {@link Row} of a row sequence
     * @throws IllegalStateException if the call that was passed this {@link Result} has
     * ended
     */
    ...
    /**
     * A hint to the implementation about how many additional rows the caller
     * thinks the implementation should provide. The caller may be wrong and the
     * implementation is free to ignore this information. On the other hand ignoring
     * this hint may cause performance problems.
     *
     * @param count the number of additional rows the caller is ready to process
     * @throws IllegalStateException if the call that was passed this Result has
     * ended
     */
    @Override
