...
public class CloudSpannerPreparedStatement extends AbstractCloudSpannerPreparedStatement
{
	...
	private Integer performInsert(Insert insert) throws SQLException
	{
	...
	private Integer performUpdate(Update update) throws SQLException
	{
		return getDbClient().readWriteTransaction().run(new TransactionCallable<Integer>()
		{
	...
	private Integer performDelete(Delete delete) throws SQLException
	{
		return getDbClient().readWriteTransaction().run(new TransactionCallable<Integer>()
		{
