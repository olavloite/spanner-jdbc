 ...
 *
 */
public abstract class AbstractCloudSpannerPreparedStatement extends CloudSpannerStatement
    implements PreparedStatement {
  private ParameterStore parameters = new ParameterStore();

  public AbstractCloudSpannerPreparedStatement(CloudSpannerConnection connection,
