...
public class CloudSpannerXAException extends XAException {
  ...
  static final String COMMIT_METHODS_NOT_ALLOWED_WHEN_ACTIVE =
  ...
  static final String PREPARE_WITH_SAME =
  ...
  static final String ONE_PHASE_SAME =
  ...
  static final String TWO_PHASE_IDLE =
