...
public class MetaDataTester {
  ...
  private static final String[] TABLES =
      {"ASYNCTEST", "TEST", "TESTCHILD", "TEST_QUOTED", "TEST_WITH_ARRAY"};
  ...
  private static final int[][] COLUMN_TYPES = {
      {Types.BIGINT, Types.BINARY, Types.BOOLEAN, Types.DOUBLE, Types.NVARCHAR, Types.DATE,
          Types.TIMESTAMP},
      {Types.BIGINT, Types.BINARY, Types.BOOLEAN, Types.DOUBLE, Types.NVARCHAR, Types.DATE,
          Types.TIMESTAMP},
  ...
  private void runOtherMetaDataTests() throws SQLException {
    ...
    for (String table : TABLES) {
      ...
      try (ResultSet rs = metadata.getBestRowIdentifier("", "", table,
