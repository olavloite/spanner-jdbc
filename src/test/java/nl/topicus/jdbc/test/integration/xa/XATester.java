...
public class XATester {
  ...
  public void testXA(String projectId, String instanceId, String database, String pvtKeyPath)
      throws SQLException {
  ...
  private void deleteTestRow(CloudSpannerXAConnection xaConnection)
  ...
  private void testXARollback(CloudSpannerXAConnection xaConnection)
      throws SQLException, XAException {
  ...
  private Xid prepareDeleteRow(CloudSpannerXAConnection xaConnection)
      throws SQLException, XAException {
    Connection connection = xaConnection.getConnection();
    Xid xid = getRandomXid();
    xaConnection.start(xid, XAResource.TMNOFLAGS);
  ...
  private void testXARecover(CloudSpannerXAConnection xaConnection)
      throws SQLException, XAException {
