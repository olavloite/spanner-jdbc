...
public class CloudSpannerDatabaseMetaDataTest {
  ...
  public void testSupportsTransactionIsolationLevel() throws SQLException {
    assertFalse(
        testSubject.supportsTransactionIsolationLevel(Connection.TRANSACTION_READ_UNCOMMITTED));
    assertFalse(
        testSubject.supportsTransactionIsolationLevel(Connection.TRANSACTION_READ_COMMITTED));
    assertFalse(
        testSubject.supportsTransactionIsolationLevel(Connection.TRANSACTION_REPEATABLE_READ));
  ...
  public void testSupportsResultSetConcurrency() throws SQLException {
    assertTrue(testSubject.supportsResultSetConcurrency(ResultSet.TYPE_FORWARD_ONLY,
        ResultSet.CONCUR_READ_ONLY));
    assertFalse(testSubject.supportsResultSetConcurrency(ResultSet.TYPE_FORWARD_ONLY,
        ResultSet.CONCUR_UPDATABLE));
    assertFalse(testSubject.supportsResultSetConcurrency(ResultSet.TYPE_SCROLL_INSENSITIVE,
        ResultSet.CONCUR_READ_ONLY));
    assertFalse(testSubject.supportsResultSetConcurrency(ResultSet.TYPE_SCROLL_INSENSITIVE,
        ResultSet.CONCUR_UPDATABLE));
    assertFalse(testSubject.supportsResultSetConcurrency(ResultSet.TYPE_SCROLL_SENSITIVE,
        ResultSet.CONCUR_READ_ONLY));
    assertFalse(testSubject.supportsResultSetConcurrency(ResultSet.TYPE_SCROLL_SENSITIVE,
        ResultSet.CONCUR_UPDATABLE));
  }
  ...
  public void testSupportsSavePoints() throws SQLException {
    ...
    CloudSpannerConnection connection =
        new CloudSpannerConnection(mock(DatabaseClient.class), mock(BatchClient.class));
