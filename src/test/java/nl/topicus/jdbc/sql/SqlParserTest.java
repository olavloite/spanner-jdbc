...
public class SqlParserTest
{
	...
	/**
	 * This test should not throw an exception, but it does as the SQL parser is
	 * not able to parse a boolean expression. The workaround is to wrap the
	 * boolean expression in a case when ... then expression.
	 * 
