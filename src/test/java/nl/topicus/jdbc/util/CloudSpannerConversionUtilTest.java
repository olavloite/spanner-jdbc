...
public class CloudSpannerConversionUtilTest {
  ...
  public void testToSqlDateCalendar() {
    ...
    assertEquals(new Date(cal2.getTimeInMillis()), CloudSpannerConversionUtil
        .toSqlDate(com.google.cloud.Date.fromYearMonthDay(2000, 1, 1), cal1));
    assertEquals(new Date(0l), CloudSpannerConversionUtil
        .toSqlDate(com.google.cloud.Date.fromYearMonthDay(1970, 1, 1), cal1));
  }
  ...
  public void testToCloudSpannerDates() {
    assertArrayEquals(
        ...
        CloudSpannerConversionUtil
            .toCloudSpannerDates(new Date[] {new Date(2000 - 1900, 0, 1), new Date(0l)}).toArray());
  }
  ...
  public void testToJavaDates() {
    ...
    assertArrayEquals(new Date[] {new Date(2000 - 1900, 0, 1), new Date(cal.getTimeInMillis())},
        CloudSpannerConversionUtil
            .toJavaDates(Arrays.asList(com.google.cloud.Date.fromYearMonthDay(2000, 1, 1),
                com.google.cloud.Date.fromYearMonthDay(1970, 1, 1)))
            .toArray());
  }
  ...
  public void testToCloudSpannerTimestamp() {
    ...
    com.google.cloud.Timestamp gts2 =
        com.google.cloud.Timestamp.parseTimestamp("2000-01-01T13:15:10.0001001Z");
  ...
  public void testToCloudSpannerTimestamps() {
    ...
    List<com.google.cloud.Timestamp> gts1 =
        CloudSpannerConversionUtil.toCloudSpannerTimestamps(new Timestamp[] {ts});
    List<com.google.cloud.Timestamp> gts2 =
        Arrays.asList(com.google.cloud.Timestamp.parseTimestamp("2000-01-01T13:15:10.0001001Z"));
  ...
  public void testToSqlTime() {
    com.google.cloud.Timestamp ts =
        com.google.cloud.Timestamp.parseTimestamp("2000-01-01T13:15:10.0010001Z");
  ...
  public void testConvert() throws SQLException {
    assertEquals(Boolean.TRUE,
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), Boolean.class));
    assertEquals(Boolean.TRUE,
        CloudSpannerConversionUtil.convert(Long.valueOf(1), Type.int64(), Boolean.class));
    assertEquals(Boolean.TRUE,
        CloudSpannerConversionUtil.convert(Double.valueOf(1d), Type.float64(), Boolean.class));
    assertEquals(Boolean.TRUE,
        CloudSpannerConversionUtil.convert("True", Type.string(), Boolean.class));

    assertEquals(Boolean.FALSE,
        CloudSpannerConversionUtil.convert(Boolean.FALSE, Type.bool(), Boolean.class));
    assertEquals(Boolean.FALSE,
        CloudSpannerConversionUtil.convert(Long.valueOf(0), Type.int64(), Boolean.class));
    assertEquals(Boolean.FALSE,
        CloudSpannerConversionUtil.convert(Double.valueOf(0d), Type.float64(), Boolean.class));
    assertEquals(Boolean.FALSE,
        CloudSpannerConversionUtil.convert("False", Type.string(), Boolean.class));

    assertEquals(BigDecimal.ONE,
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), BigDecimal.class));
    assertEquals(BigDecimal.TEN,
        CloudSpannerConversionUtil.convert(Long.valueOf(10), Type.int64(), BigDecimal.class));
    assertEquals(BigDecimal.valueOf(10.1d), CloudSpannerConversionUtil
        .convert(Double.valueOf(10.1d), Type.float64(), BigDecimal.class));
    assertEquals(new BigDecimal("10.2"),
        CloudSpannerConversionUtil.convert("10.2", Type.string(), BigDecimal.class));

    assertEquals(Long.valueOf(1),
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), Long.class));
    assertEquals(Long.valueOf(10),
        CloudSpannerConversionUtil.convert(Long.valueOf(10), Type.int64(), Long.class));
    assertEquals(Long.valueOf(10),
        CloudSpannerConversionUtil.convert(Double.valueOf(10.1d), Type.float64(), Long.class));
    assertEquals(new Long("10"),
        CloudSpannerConversionUtil.convert("10", Type.string(), Long.class));

    assertEquals(Integer.valueOf(1),
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), Integer.class));
    ...
    assertEquals(new Integer("10"),
        CloudSpannerConversionUtil.convert("10", Type.string(), Integer.class));
    ...
    assertEquals(BigInteger.valueOf(10), CloudSpannerConversionUtil.convert(Double.valueOf(10.1d),
        Type.float64(), BigInteger.class));
    assertEquals(new BigInteger("10"),
        CloudSpannerConversionUtil.convert("10", Type.string(), BigInteger.class));

    assertEquals(Float.valueOf(1),
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), Float.class));
    ...
    assertEquals(new Float("10.2"),
        CloudSpannerConversionUtil.convert("10.2", Type.string(), Float.class));

    assertEquals(Double.valueOf(1),
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), Double.class));
    ...
    assertEquals(new Double("10.2"),
        CloudSpannerConversionUtil.convert("10.2", Type.string(), Double.class));

    assertEquals("true",
        CloudSpannerConversionUtil.convert(Boolean.TRUE, Type.bool(), String.class));
    assertEquals("10",
        CloudSpannerConversionUtil.convert(Long.valueOf(10), Type.int64(), String.class));
    assertEquals("10.1",
        CloudSpannerConversionUtil.convert(Double.valueOf(10.1d), Type.float64(), String.class));
