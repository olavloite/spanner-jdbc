...
public class CloudSpannerConnectionTest {
  ...
  private static CloudSpannerConnection createConnection(Properties properties)
      throws SQLException {
  ...
  public void testCreateStatement() throws SQLException {
    ...
    Assert.assertNotNull(
        subject.createStatement(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY));
    Assert.assertNotNull(subject.createStatement(ResultSet.TYPE_FORWARD_ONLY,
  ...
  private void testGetDynamicConnectionProperty(Connection connection, String property,
  ...
  public void testClosedAbstractCloudSpannerConnection() throws SQLException, NoSuchMethodException,
    ...
    testClosed(AbstractCloudSpannerConnection.class, "setClientInfo",
        new Class<?>[] {String.class, String.class}, new Object[] {"TEST", "TEST"});
    testClosed(AbstractCloudSpannerConnection.class, "setClientInfo",
        new Class<?>[] {Properties.class}, new Object[] {null});
  ...
  @Test
  public void testClosedCloudSpannerConnection() throws SQLException, NoSuchMethodException,
      SecurityException, IllegalAccessException, IllegalArgumentException {
    ...
    testClosed(CloudSpannerConnection.class, "prepareCall", new Class<?>[] {String.class},
        new Object[] {"TEST"});
    testClosed(CloudSpannerConnection.class, "nativeSQL", new Class<?>[] {String.class},
        new Object[] {"TEST"});
    testClosed(CloudSpannerConnection.class, "prepareStatement", new Class<?>[] {String.class},
        new Object[] {"TEST"});
    ...
    testClosed(CloudSpannerConnection.class, "prepareStatement",
        ...
        new Object[] {"TEST", 0, 0, 0});
    testClosed(CloudSpannerConnection.class, "prepareStatement",
        new Class<?>[] {String.class, int.class}, new Object[] {"TEST", 0});
    testClosed(CloudSpannerConnection.class, "prepareStatement",
        new Class<?>[] {String.class, int[].class}, new Object[] {"TEST", new int[] {0}});
    testClosed(CloudSpannerConnection.class, "prepareStatement",
        new Class<?>[] {String.class, String[].class},
        new Object[] {"TEST", new String[] {"COL1"}});
    testClosed(CloudSpannerConnection.class, "createArrayOf",
        new Class<?>[] {String.class, Object[].class},
        new Object[] {"TEST", new Object[] {"COL1"}});

    testClosed(CloudSpannerConnection.class, "setSavepoint", new Class<?>[] {String.class},
        new Object[] {"TEST"});
    testClosed(CloudSpannerConnection.class, "rollback", new Class<?>[] {Savepoint.class},
        new Object[] {null});
  ...
  private void testClosed(Class<? extends AbstractCloudSpannerConnection> clazz, String name,
      Class<?>[] paramTypes, Object[] args) throws NoSuchMethodException, SecurityException,
  ...
  public void testGetBucket() {
    assertEquals("test-bucket",
        CloudSpannerConnection.getBucket("gs://test-bucket/config/key.json"));
  }

  @Test
  public void testGetBlob() {
    assertEquals("config/key.json",
        CloudSpannerConnection.getBlob("gs://test-bucket/config/key.json"));
  }
