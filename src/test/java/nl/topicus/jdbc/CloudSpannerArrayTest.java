...
public class CloudSpannerArrayTest {
  ...
  public CloudSpannerArrayTest() throws SQLException {
    ...
    testSubjects
        .add(CloudSpannerArray.createArray(CloudSpannerDataType.STRING, Arrays.asList(inputArray)));
  }
  ...
  public void testGetArray() throws SQLException {
    for (CloudSpannerArray testSubject : testSubjects) {
      ...
      // index is 1)
      assertArrayEquals(Arrays.copyOfRange(inputArray, 0, 2),
          (Object[]) testSubject.getArray(1, 2));
    }
  }
