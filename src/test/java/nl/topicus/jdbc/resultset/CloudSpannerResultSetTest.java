...
public class CloudSpannerResultSetTest {
  ...
  public void testNext() throws SQLException {
    try (CloudSpannerResultSet rs = new CloudSpannerResultSet(mock(CloudSpannerStatement.class),
        getMockResultSet(), "SELECT * FROM FOO")) {
  ...
  public void testGetTimestampIndex() throws SQLException {
    ...
    assertEquals(new java.sql.Timestamp(cal.getTimeInMillis()),
        subject.getTimestamp(TIMESTAMP_COLINDEX_NOTNULL));
    assertEquals(false, subject.wasNull());
  ...
  public void testGetTimestampLabel() throws SQLException {
    ...
    assertEquals(new java.sql.Timestamp(cal.getTimeInMillis()),
        subject.getTimestamp(TIMESTAMP_COL_NOT_NULL));
    assertEquals(false, subject.wasNull());
  ...
  public void testGetArrayLabel() throws SQLException {
    ...
    assertEquals(
        CloudSpannerArray.createArray(CloudSpannerDataType.INT64, Arrays.asList(1L, 2L, 3L)),
